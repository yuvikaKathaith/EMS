    ...
    <div className='flex flex-row justify-between bg-[#1c1c1c] m-9 -mt-3 p-5 rounded-lg'>
        ...
        <div>
            <div>
                ...
                <textarea className='border border-gray-300 mb-3 p-3 w-[600px] h-[200px] rounded-sm' placeholder='For eg. Design a clean and modern user interface for a web application. Focus on user experience (UX) and usability, ensuring an intuitive layout with consistent typography, spacing, and color schemes.'/>
            </div>
            <button className='w-[600px] h-10 rounded-sm text-center font-semibold bg-blue-500'>Create Task</button>
        </div>
    </div>
  )
}
