...
const AdminHeader = (props) => {
  ...
  return (
    <div className='flex flex-row justify-between p-10 h-full bg-white dark:bg-gray-900'>
      <div>
      ...
      <div className='flex flex-row items-center gap-6'>
        <div className='flex flex-row gap-3 mt-5'>
          ...
          >
            <div
              className={darkMode? 'w-6 h-6 flex items-center justify-center rounded-full bg-gray-700 shadow-md transform transition-all duration-300 dark:bg-gray-700 ' : 'w-6 h-6 flex items-center justify-center rounded-full bg-slate-500 dark:bg-slate-800 shadow-md transform transition-all duration-300'}
            >
